...
namespace SIVIO.Entidades
{
    ...
    public partial class TBL_INTERVENCION_ACOM_PROFESIONAL
    {
        public System.Guid PK_INTERVENCIONACOMPROFESIONAL { get; set; }
        public System.Guid FK_INTERVENCION { get; set; }
        public string VC_TIPO { get; set; }
        public System.DateTime DT_FECHA { get; set; }
        public string VC_LUGAR { get; set; }
        public string VC_PERSONASPARTICIPANTES { get; set; }
