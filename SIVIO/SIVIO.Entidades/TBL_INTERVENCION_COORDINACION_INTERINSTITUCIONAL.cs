...
namespace SIVIO.Entidades
{
    ...
    public partial class TBL_INTERVENCION_COORDINACION_INTERINSTITUCIONAL
    {
        public System.Guid PK_COORDINACIONINTERINSTITUCIONAL { get; set; }
        public System.Guid FK_INTERVENCION { get; set; }
        public System.DateTime VC_FECHA { get; set; }
        public int FK_INSTITUCION { get; set; }
        public string VC_PERSONA { get; set; }
